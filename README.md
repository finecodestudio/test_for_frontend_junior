...
> Для работы с проектом потребуется [Node.js](https://nodejs.org/en/) версии 16.x.x или выше.

1. Склонировать репозиторий 
```shell
git clone git@github.com:finecodestudio/test_for_frontend_junior.git
```
2. Установить модули
```shell
npm i
